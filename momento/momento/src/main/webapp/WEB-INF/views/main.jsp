...
<html>
	...
	<body class="is-preload">
		...
		<!-- Footer -->
			...
			<div class="quickmenu">
				<ul>
				  <li><a href="#"><img src="https://www.facnroll.co.kr/_img/utility/icon_blog.png" width=50 height=50></a></li>
				  <li><a href="#"><img src="https://www.abijouclinic.com/img/main/step_02_icon02.png" width=50 height=50></li>
				  <li><a href="#"><img src="https://www.abijouclinic.com/img/main/step_02_icon01.png" width=50 height=50></li>
				</ul>
			  </div>
		...
		<!-- Scripts -->
			...
			$(document).ready(function(){
				...
				$(window).scroll(function() {
				  ...
				  $(".quickmenu").stop().animate({"top":position+currentPosition+"px"},750);
				});
			  });
			</script>
	</body>
